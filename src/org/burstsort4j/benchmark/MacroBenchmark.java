...
public class MacroBenchmark {
    ...
    /**
     * Creates a new instance of MacroBenchmark.
     */
    private MacroBenchmark() {
    }
    ...
    public static void main(String[] args) {
        ...
        // limit to those that perform reasonably well with larger data sets
        SortRunner[] runners = {
            SortRunner.HEAP,
            SortRunner.INTRO,
            SortRunner.QUICK,
    ...
    private static void usage() {
        System.out.println("Usage: MacroBenchmark [options]");
